...
class Project( Topo):
	def build(self, **_opts):
		...
		s13 = self.addSwitch('s13', cls = OVSSwitch , protocols = "OpenFlow13", ip = '10.0.13.1')
		s14 = self.addSwitch('s14', cls = OVSSwitch , protocols = "OpenFlow13", ip = '10.0.14.1')
		...
		self.addLink(s1,s8,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s2,s4,delay='1ms',bw = 1e6, max_queue_size=30)
		self.addLink(s2,s3,delay='1ms',bw = 1e6, max_queue_size=30)
		...
		self.addLink(s6,s13,delay='1ms',bw = 1e6, max_queue_size=30)
		self.addLink(s6,s10,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s7,s8,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s8,s9,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s9,s14,delay='1ms',bw = 1e6, max_queue_size=30)
		self.addLink(s9,s12,delay='1ms',bw = 1e6, max_queue_size=30)
		self.addLink(s9,s10,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s11,s12,delay='1ms',bw = 1e6, max_queue_size=30)
		self.addLink(s11,s14,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s12,s13,delay='1ms',bw = 1e6, max_queue_size=30)
		
		self.addLink(s14,s13,delay='1ms',bw = 1e6, max_queue_size=30)
...
def run():
	...
	net.start()
	#net.pingAll()
	timeTotal = 1200 #4000#1e600#400#840
	loadLevel = 2
	bw = 9750.0#9.75
	time.sleep(5)
	...
	for k in range(10):#26
		print("Traffic round ",k)
		for i in range(30*loadLevel):#10#3*loadlevel
